...
var logFieldOrder = []string{"provider", "model", "mode", "budget", "level", "original_mode", "original_value", "min", "max", "clamped_to", "trace_id", "span_id", "proxy_websocket_session_id", "traceparent", "error"}
